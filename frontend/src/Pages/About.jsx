...
function About() {
    return <div className="max-w[1400px] mx-auto w-full sm:h-[38em] h-[75em] bg-fourthColor mt-20">
        <h1 className="text-5xl font-bold text-center text-primeryColor pt-8">About Us</h1>
        <hr className="max-w[1400px] mx-auto w-40 border-seconderyColor border-b-2 sm:ml-[34.5em]  ml-32 mt-2" />
        ...
        <div className="sm:flex justify-center pt-10">
            <div className="bg-seconderyColor max-w[1400px] mx-auto  sm:w-[28em] w-[24em] sm:h-48 h-62 sm:mb-0 mb-20 rounded-lg">
